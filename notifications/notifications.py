...
Dit is een automatisch verzonden bericht door het dashboard deelmobiliteit.
    ...
    return open_microhub.substitute(name_microhub = stop.name, url_microhub = "https://dashboarddeelmobiliteit.nl/map/zones/" + stop.stop_id,
...
Dit is een automatisch verzonden bericht door het dashboard deelmobiliteit.
    ...
    stop = state_change.stop
    return close_microhub.substitute(name_microhub = stop.name, url_microhub = "https://dashboarddeelmobiliteit.nl/map/zones/" + stop.stop_id,
